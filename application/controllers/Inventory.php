<?php
	class Inventory extends CI_Controller{
		...
		public function index (){
			...
			$this->load->model('M_inventory');
			$getStandards = $this->M_inventory->getStandards();
			$getGender = $this->M_inventory->getGender();
		...
		public function getRecords(){
			...
			$getStandards = $this->M_inventory->getStandards();
			$getGender = $this->M_inventory->getGender();
			$records = $this->M_inventory->getRecords($standard, $gender);
		...
		public function filter(){
			$data['inventory']= $this->M_inventory->filter_data();
		...
		public function getdatakantor(){
			...
			$getdataktr = $this->M_inventory->getdataktr($id_regional);
			// var_dump($getdataktr);
		...
		public function getFilteredData() {
		    ...
		    $filteredData = $this->M_inventory->getFilteredData($regional, $status);
		...
		public function getdatastatus(){
			$id_regional = $this->input->post('data_regional');
			$getdatastt = $this->M_inventory->getdatastt($id_regional);
			// var_dump($getdataktr);
	    ...
	    public function proses_edit_data($Order_Id){
	    	$this->M_inventory->proses_edit_data($Order_Id);
	    ...
	    public function ajax_update()
	    {
		    ...
		    $update = $this->M_inventory->ajax_update($data, $Order_Id);
	 ...
	 //    public function nik_available($str)
		...
		public function edit_inventory($id){
			$where 				= array('id' => $id);
			$data['inventory'] 	= $this->M_inventory->edit_data($where,'inventory')->result();
			$this->load->view('templates/header');
			$this->load->view('templates/sidebar');
		...
		public function update_inventory($id){
			...
			// } else {
				...
				$this->M_inventory->update_data($where, $data, 'inventory');
		...
		public function detail_penduduk($id){
			$this->load->model('M_inventory');
			$detail_inventory 			= $this->M_inventory->detail_data($nik);
