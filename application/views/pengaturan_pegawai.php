        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="<?php echo base_url('pengaturan_pegawai/update_pengaturan_pegawai') ?>">
                <div class="card-body">
...
<!-- <div class="content-wrapper">
	<section class="content">
			<form method="post" action="<?php echo base_url('pengaturan_pegawai/update_pengaturan_pegawai') ?>">
				<div style="width: 50%"> 
