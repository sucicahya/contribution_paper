      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                <?php echo form_open("Inventory_6/getRecords");?>
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">REPORT FORM</h3>
							<a href="<?php echo base_url('inventory_6/index'); ?>" class="close" aria-label="close">&times;</a>
            </div>
          </div>
	      <div class="modal-body">
	      	<?php echo form_open_multipart('Inventory_6/proses_edit_data/'.$inv->Order_Id);?>
