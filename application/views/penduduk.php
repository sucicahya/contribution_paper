                  ...
                  <?php 
					      	...
					      	<tr>
					      		...
					      		<td><?php echo $pdk->nik ?></td>
										...
										<td><?php echo $pdk->status_kependudukan ?></td><!-- 
										...
										<td>
											<a href="<?=site_url('penduduk/detail_penduduk/'.$pdk->nik)?>" class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i></a>
											<a href="<?=site_url('penduduk/hapus/'.$pdk->nik)?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin akan menghapusnya?')"><i class="fa fa-trash"></i></a>
											<a href="<?=site_url('penduduk/edit_penduduk/'.$pdk->nik)?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
										</td>
					      	</tr>
					      <?php endforeach; ?>
                  </tbody>
