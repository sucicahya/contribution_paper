<div class="content-wrapper">
  <section id="career" class="container">
    ...
    <!-- <a href="<?php echo base_url('pindah_kelurahan/index'); ?>" class="close" aria-label="close">&times;</a> -->
    <!-- <?php echo validation_errors(); ?> -->
    <font color="red" size="2"><i><?php echo validation_errors(); ?></i></font>
  <form action="<?php echo base_url().'pindah_kelurahan/tambah_aksi'; ?>" method="post">
    ...
    <div class="row-fluid">      
        <?php 
          foreach ($pindah_kelurahan as $pk) :
        ?>
      <!-- Left Column -->
      <div class="span6">
        <h4>NIK</h4>
       ...
       <p><input type="text" name="kelurahan_tujuan" value="<?= set_value('kelurahan_tujuan') ?>" class="form-control"></p>
        <h5>Kecamatan</h5>
       <p><input type="text" name="kecamatan_tujuan" class="form-control" value="<?php echo $pk->kecamatan ?>"/></p>
       <h5>Kabupaten</h5>
...
<!-- <div class="content-wrapper">
  <section class="content">
      ...
      <form action="<?php echo base_url().'pindah_kelurahan/tambah_aksi'; ?>" method="post">
        ...
        <div> 
          <label>TTD Lurah</label>
          <input type="text" name="ttd_lurah" class="form-control">
        </div>
        <div> 
