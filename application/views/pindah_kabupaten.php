<div class="content-wrapper">
	<section id="career" class="container">
		<?php if ($this->session->flashdata('success') == TRUE) : ?>
				...
				<?php endif; ?>
  	<!-- <a href="<?php echo base_url('pindah_kabupaten/index'); ?>" class="close" aria-label="close">&times;</a> -->
	<!-- <form action="<?php echo base_url().'pindah_kabupaten/tambah_aksi'; ?>" method="post"> -->
    <!-- <?php echo validation_errors(); ?> -->
    <font color="red" size="2"><i><?php echo validation_errors(); ?></i></font>
		<?php echo form_open_multipart('pindah_kabupaten/tambah_aksi'); ?>
    ...
    <div class="row-fluid">
      <?php 
          foreach ($pindah_kabupaten as $pk) :
        ?>
      <!-- Left Column -->
      <div class="span6">
        <h4>NIK</h4>
       ...
       <h5>Kabupaten Tujuan</h5>
       <p><input type="text" name="kabupaten_tujuan" value="<?= set_value('kabupaten_tujuan') ?>" class="form-control"></p>
     <hr color="black" size="3">
       <!-- <h5>NIK Pindah 1</h5>
     ...
     <div class="span6">
      ...
      <hr color="black" size="3">
       ...
       <p><input type="text" name="provinsi_tujuan" value="<?= set_value('provinsi_tujuan') ?>" class="form-control"></p>
       ...
       <p><input type="text" name="status_kk_tidak" value="<?= set_value('status_kk_tidak') ?>" class="form-control"></p>
       <!-- <h5>Tanda Tangan</h5>
