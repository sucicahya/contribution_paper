<?php 
	...
	class M_pindah_kecamatan extends CI_Model {

		public function tampil_data(){
			$this->db->join('data_penduduk', 'surat_pindah.nik=data_penduduk.nik');
			$this->db->order_by('tanggal_ajuan', 'DESC');
			return $this->db->get_where('surat_pindah', array('jenis_surat' => 'surat pindah kecamatan'));
		}

		// public function detail_data($id = NULL){
		// 	$this->db->join('data_penduduk', 'surat_pindah_kecamatan.nik=data_penduduk.nik');
		// 	$query = $this->db->get_where('surat_pindah_kecamatan', array('id' => $id))->row();
		// 	return $query;
		// }
