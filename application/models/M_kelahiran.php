<?php 
	...
	class M_kelahiran extends CI_Model {
		...
		public function tampil_data(){
			$this->db->join('data_penduduk', 'surat_kelahiran.nik_pelapor=data_penduduk.nik');
		...
		// 	$this->db->join('data_penduduk', 'surat_kelahiran.nik_pelapor=data_penduduk.nik');
		// 	$query = $this->db->get_where('surat_kelahiran', array('id' => $id))->row();
		// 	return $query;
		// }
		...
		public function edit_data_pelapor($where, $table){
			$this->db->join('data_penduduk', 'surat_kelahiran.nik_pelapor=data_penduduk.nik');
			return $this->db->get_where($table, $where);
		}

		public function update_data_pelapor($where, $data, $table){
			$this->db->where($where);
			$this->db->update($table, $data);
		}

		public function edit_data_saksi_satu($where, $table){
			$this->db->join('data_penduduk', 'surat_kelahiran.nik_saksi_satu=data_penduduk.nik');
			return $this->db->get_where($table, $where);
		}
		...
		public function edit_data_saksi_dua($where, $table){
			$this->db->join('data_penduduk', 'surat_kelahiran.nik_saksi_dua=data_penduduk.nik');
			return $this->db->get_where($table, $where);
		}
		...
		public function get_keyword($keyword){
			...
			$this->db->like('nama_bayi', $keyword);
			$this->db->or_like('id_surat', $keyword);
			$this->db->or_like('data_penduduk.nama', $keyword);
		...
		{
			$this->db->join('data_penduduk', 'surat_kelahiran.nik_pelapor=data_penduduk.nik');
			$data_kelahiran = $this->db->get_where('surat_kelahiran', array('id' => $id));
			return $data_kelahiran->result();
		}

		// public function getData_saksi_satu($id = NULL)
		// {
		// 	$this->db->join('data_penduduk', 'surat_kelahiran.nik_saksi_satu=data_penduduk.nik');
		// 	$data_kelahiran = $this->db->get_where('surat_kelahiran', array('id' => $id));
		// 	return $data_kelahiran->result();
		...
		// public function getData_saksi_dua($id = NULL)
		// {
		// 	$this->db->join('data_penduduk', 'surat_kelahiran.nik_saksi_dua=data_penduduk.nik');
		// 	$data_kelahiran = $this->db->get_where('surat_kelahiran', array('id' => $id));
		// 	return $data_kelahiran->result();
